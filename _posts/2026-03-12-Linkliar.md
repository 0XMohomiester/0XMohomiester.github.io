...
Another indication of **memory corruption** can be seen in some registers containing what appears to be ASCII-like data rather than valid memory addresses, for example:
